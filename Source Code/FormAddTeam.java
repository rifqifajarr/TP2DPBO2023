 ...
 * @author COMPUTER
 */
public class FormAddTeam extends javax.swing.JFrame {
    ...
    // method untuk masukin data ke database
    public void insertData() {
        ...
        if (name.isEmpty() | principal.isEmpty()) {
            ...
            String sql = "INSERT INTO teams (team_name, team_principal) VALUES ('"+name+"', '"+principal+"')";
            db.updateQuery(sql);
        }
        // Show Information
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormAddTeam.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormAddTeam().setVisible(true);
            }
        });
    }
